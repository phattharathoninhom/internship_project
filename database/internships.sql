...
('67101010101', 'กมล', 'ใจดี', 'kamol@swu.ac.th', '0812345001', '1234'),
('67101010102', 'ขวัญชัย', 'มานะ', 'kwanchai@swu.ac.th', '0812345002', '1234'),
('67101010103', 'จิราพร', 'รักษ์เรียน', 'jiraporn@swu.ac.th', '0812345003', '1234'),
('67101010104', 'ชัชวาล', 'เก่งกาจ', 'chatchawan@swu.ac.th', '0812345004', '1234'),
('67101010105', 'ณัฐพล', 'เรียนดี', 'nattapol@swu.ac.th', '0812345005', '1234'),
('67101010106', 'รถถัง', 'ประจัญบาน', 'rodthang@swu.ac.th', '0812345006', '1234'),
('67101010107', 'ธนพล', 'พากเพียร', 'thanapol@swu.ac.th', '0812345007', '1234'),
('67101010108', 'บุญส่ง', 'จริงใจ', 'boonsong@swu.ac.th', '0812345008', '1234'),
('67101010109', 'ปิยะมาศ', 'งามเลิศ', 'piyamas@swu.ac.th', '0812345009', '1234'),
('67101010110', 'พรเทพ', 'ใจงาม', 'pornthep@swu.ac.th', '0812345010', '1234');
...
VALUES
('67101010101', 'บริษัท กสิกรไทย จำกัด (มหาชน)', 'ธนาคารกสิกรไทย สำนักงานใหญ่ ราษฎร์บูรณะ กทม.', 'คุณสมชาย สายเปย์', '2026-06-01', '2026-08-31', 1, NULL),
('67101010102', 'บริษัท ปูนซิเมนต์ไทย จำกัด (มหาชน) - SCG', '1 ถนนปูนซิเมนต์ไทย บางซื่อ กทม.', 'คุณสมหญิง จริงใจ', '2026-06-01', '2026-08-31', 2, 'เอกสารครบถ้วน อนุมัติได้'),
('67101010103', 'Google Thailand', 'อาคารพาร์คเวนเชอร์ อีโคเพล็กซ์ ถนนวิทยุ กทม.', 'Mr. John Doe', '2026-06-15', '2026-09-15', 3, 'ออกใบส่งตัวเรียบร้อย'),
('67101010104', 'บริษัท ปตท. จำกัด (มหาชน)', '555 ถนนวิภาวดีรังสิต จตุจักร กทม.', 'คุณวิชัย รักชาติ', '2026-06-01', '2026-08-31', 4, 'ฝึกงานเสร็จสิ้น ประเมินผ่าน'),
('67101010105', 'บริษัท ไลน์ แมน วงใน จำกัด', 'อาคารที-วัน ถนนสุขุมวิท กทม.', 'คุณเก่ง การค้า', '2026-06-01', '2026-08-31', 1, NULL),
('67101010106', 'Agoda Services Co., Ltd.', 'อาคารดิออฟฟิศเศส แอท เซ็นทรัลเวิลด์ กทม.', 'Ms. Sarah Connor', '2026-06-01', '2026-08-31', 9, 'นิสิตขอยกเลิกเนื่องจากเปลี่ยนที่ฝึกงาน'),
('67101010107', 'Shopee (Thailand)', 'อาคารสิงห์ คอมเพล็กซ์ ถนนเพชรบุรีตัดใหม่ กทม.', 'คุณพงษ์ศักดิ์ ขยันงาน', '2026-06-01', '2026-08-31', 2, 'รอตรวจเอกสารเพิ่มเติม'),
('67101010108', 'True Corporation', '18 ถนนรัชดาภิเษก ห้วยขวาง กทม.', 'คุณมานะ มานี', '2026-06-01', '2026-08-31', 3, 'จัดส่งใบส่งตัวทางไปรษณีย์แล้ว'),
('67101010109', 'TikTok Thailand', 'อาคารปาร์ค สีลม ถนนคอนแวนต์ กทม.', 'คุณจอย ลดา', '2026-07-01', '2026-10-31', 1, NULL),
('67101010110', 'มิตซูบิชิ มอเตอร์ส (ประเทศไทย)', 'นิคมอุตสาหกรรมแหลมฉบัง จ.ชลบุรี', 'คุณสมยศ รถแรง', '2026-06-01', '2026-08-31', 2, 'อาจารย์ที่ปรึกษาพิจารณาแล้ว');